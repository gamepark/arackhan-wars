...
export class IceElementalActionRule extends CardActionRule {
  ...
  getPlayerMoves() {
    return [
      this.customMove(CustomMoveType.ChooseEffect, { type: EffectType.SetAttackDefense, attack: 0, defense: 3 }),
      this.customMove(CustomMoveType.ChooseEffect, { type: EffectType.SetAttackDefense, attack: 2, defense: 1 }),
      this.customMove(CustomMoveType.ChooseEffect, { type: EffectType.SetAttackDefense, attack: 3, defense: 0 })
    ]
  }
